...
const FloatingRobot = () => {
  ...
  return (
    <div className="w-full max-w-7xl mx-auto flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center my-4 overflow-hidden z-20">
      {/* Left Side Content */}
      <div className="lg:col-span-7 flex flex-col justify-center space-y-4 lg:pr-6">
      ...
      <div className="lg:col-span-5 bg-white rounded-[2rem] shadow-xl p-6 border border-slate-100 flex flex-col justify-center relative">

        <div className="absolute -top-3 -right-3 bg-indigo-50 text-indigo-600 p-2.5 rounded-xl shadow-sm hidden sm:block transform rotate-12 text-lg">
          ✈️
        </div>
        <div className="absolute -bottom-3 -left-3 bg-pink-50 text-pink-500 p-2.5 rounded-full shadow-sm hidden sm:block transform -rotate-12 text-sm">
          ❤️
        </div>
