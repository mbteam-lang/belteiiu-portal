                    ...
                    {facultiesData && (
                        facultiesData.data?.map((items, index) => (
                            <Link key={index} to={items.link || `#`} className="group">
                                <div
                                    className="rounded-xl flex items-center gap-4 w-full text-white border transition-all duration-300 hover:shadow-lg hover:-translate-y-1 overflow-hidden"
                                    style={{
                                ...
                                >
                                    <div className="flex justify-center items-center w-24 h-24 bg-white/95 p-3 shrink-0">
                                        <img
                                            src={items.image}
                                            alt={items.faculty}
                                            onError={(e) => {
