  ...
  return (
    <div className='min-h-screen py-4 md:py-6'>
      <section className='max-w-7xl m-auto px-3 md:px-6 space-y-3 md:space-y-6'>
        ...
        <div className='bg-white dark:bg-[#353535] rounded-xl border border-slate-200 dark:border-slate-700 p-4 md:p-8 shadow-sm space-y-4 md:space-y-6 text-slate-600 dark:text-slate-200 leading-relaxed text-md md:text-lg'>
