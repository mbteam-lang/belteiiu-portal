                            ...
                            <div className="space-y-1 lg:space-y-2">
                                {(country.collaborations || []).map((item, idx) => {
                                    return (
                                        <div
                                            key={item.id || idx}
                                            className="flex items-center justify-between bg-white dark:bg-[#353535] rounded-lg p-4 border border-gray-100 dark:border-slate-700 hover:border-gray-200 dark:hover:border-slate-600 hover:bg-gray-50/40 dark:hover:bg-slate-700/50 transition-all duration-200 group"
                                        >
