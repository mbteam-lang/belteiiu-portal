            ...
            <div className="grid grid-cols-1 md:gap-3 p-4 md:space-y-0 space-y-2 select-none">
                {loading ? (
                    ...
                    academicResearch?.map((academic_research) => (
                        <Link key={academic_research.id} to={`/biu/academic_faculties/${academic_research.id}#${hashLanguage}`} rel="noopener noreferrer" className="flex rounded-lg shadow-sm overflow-hidden">
