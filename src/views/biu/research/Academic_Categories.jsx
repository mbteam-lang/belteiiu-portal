            ...
            <div className="grid grid-cols-1 md:gap-3 p-4 md:space-y-0 space-y-2 select-none max-w-7xl m-auto">
                {loading ? (
                    ...
                    academicCategories?.map((academic_research) => (
                        <Link key={academic_research.id} to={`/biu/academic_faculties/${academic_research.id}`} rel="noopener noreferrer" className="flex rounded-lg shadow-sm overflow-hidden">
